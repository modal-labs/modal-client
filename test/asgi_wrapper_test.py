...
from modal.runtime._asgi import asgi_app_wrapper
from modal.runtime.execution_context import _set_current_context_ids
...
async def test_first_message_timeout(monkeypatch):
    monkeypatch.setattr("modal.runtime._asgi.FIRST_MESSAGE_TIMEOUT_SECONDS", 0.1)  # simulate timeout
    _set_current_context_ids(["in-123"], ["fc-123"])
