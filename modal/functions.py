...
from ._packaging import get_client_package_mounts
...
class _Function(_Object, type_prefix="fu"):
    ...
    def from_args(
        ...
        if is_local():
            ...
            # TODO(michael) Not mounting external client dependencies immediately
            client_mount, *_ = get_client_package_mounts()
            all_mounts = [
                client_mount,
                *explicit_mounts,
                *entrypoint_mounts,
