...
async def debian_slim(extra_commands=None, python_packages=None, python_version=None, pip_find_links=None):
    ...
    base_image = Image.use(f"python-{python_version}-slim-buster-base", api_pb2.ShareNamespace.GLOBAL)
    builder_image = Image.use(f"python-{python_version}-slim-buster-builder", api_pb2.ShareNamespace.GLOBAL)
