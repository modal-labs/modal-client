...
class _Server:
    ...
    async def update_autoscaler(
        ...
        *,
        ...
        server.update_autoscaler(min_containers=1, max_containers=10, scaledown_window=60, buffer_containers=2)
    ...
    @staticmethod
    def _validate_wrapped_user_cls_decorators(wrapped_user_cls: type, enable_memory_snapshot: bool):
    ...
    def from_local(
        ...
        _Server._validate_wrapped_user_cls_decorators(user_cls, enable_memory_snapshot=False)
