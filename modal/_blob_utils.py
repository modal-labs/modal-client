...
def get_file_upload_spec(filename: str, rel_path: Path) -> FileUploadSpec:
    ...
    return FileUploadSpec(filename, rel_path, use_blob=use_blob, content=content, sha256_hex=sha256_hex, size=size)
