...
class _App:
    ...
    @staticmethod
    async def _init_from_name(client: _Client, name: str, namespace, environment: str):
        # Look up any existing deployment
        app_req = api_pb2.AppGetByDeploymentNameRequest(name=name, namespace=namespace, environment=environment)
        ...
        if existing_app_id is not None:
            ...
            return await _App._init_new(client, name, detach=False, deploying=True, environment=environment)
