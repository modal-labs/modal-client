...
class Retries:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            max_retries: Maximum number of retries after failures.
            backoff_coefficient: Multiplier applied to the delay after each attempt; ``1.0`` means fixed delay.
            initial_delay: Seconds before the first retry.
            max_delay: Upper cap on the delay between retries (seconds).
        """
        if max_retries < 0:
