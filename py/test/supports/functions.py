...
@server_app.server(port=8002, routing_region="us-east", enable_memory_snapshot=True)
class ServerWithEnter(BasicServer):
    pass


@server_app.server(port=8002, routing_region="us-east", serialized=True, enable_memory_snapshot=True)
class SerializedServerWithEnter(BasicServer):
    pass


@server_app.server(port=8003, routing_region="us-east", serialized=True, enable_memory_snapshot=True)
