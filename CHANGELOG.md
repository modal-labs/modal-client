...
Modal now supports Python 3.14. Python 3.14t (the free-threading build) is **not** supported, because we waiting for dependencies to be updated with free-threaded support. Additionally, Modal no longer supports Python 3.9, which has reached [end-of-life](https://devguide.python.org/versions).
