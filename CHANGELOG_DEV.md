...
- Added support for OAuth private-key JWT authentication via `MODAL_OAUTH_JWT_KEY` / `ModalClientParams.oauthJwtKey`. Provide exactly one of client secret or JWT key.
